...
<head>
	...
	<title>MediWeb | Administrador</title>
...
<body>
	<nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><img src="{{asset('dashboard/img/milogo.png')}}" class="img-responsive" style="width: 140px; margin-top: -16px;"></a>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li class="active"><a href="index.html"><em class="fa fa-home fa-fw">&nbsp;</em> Inicio</a></li>
			<li><a href="widgets.html"><em class="fa fa-user-md fa-fw">&nbsp;</em> Perfil</a></li>
			<li><a href="charts.html"><em class="fa fa-hospital-o fa-fw">&nbsp;</em> Clinica/Hospital</a></li>
			<li><a href="elements.html"><em class="fa fa-medkit fa-fw">&nbsp;</em> Enfermedades</a></li>
			<li><a href="panels.html"><em class="fa fa-sitemap fa-fw">&nbsp;</em> Areas Médicas</a></li>
			<li class="parent "><a data-toggle="collapse" href="#sub-item-1">
				<em class="fa fa-users fa-fw">&nbsp;</em> Usuarios <span data-toggle="collapse" href="#sub-item-1" class="icon pull-right"><em class="fa fa-plus"></em></span>
				</a>
