<div class="modal fade modal-square " id="Modal-Eliminar-{{$cita->IdCita}}" tabindex="-1" role="dialog" aria-labelledby="ModalEliminar" aria-hidden="true">
	{!!Form::open(['action'=>['PAdministrativo\CitaController@destroy', $cita->IdCita],'method'=>'DELETE'])!!}
		<div class="modal-dialog">
			<div class="modal-content modal-square">
				<div class="modal-header" style="background-color: #5bc0de;color:#fff;">
					...
					<h3  style="font-weight: bold; color:#fff;">Eliminar Cita</h3>
				</div>
				<div class="modal-body">					
					<h4>¿ Realmente deseas Eliminar la cita ?</h4>
				</div>
