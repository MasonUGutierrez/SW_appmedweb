...
@section('contenido')
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
			<h3 class="page-header">Nuevo <small>Administrador</small></h3>
			@if(count($errors)>0)
	...
	<div class="row">
		{!!Form::open(['url'=>'admin/usuarios/admin','method'=>'POST','autocomplete'=>'off'])!!}
		{!!Form::token()!!}
				...
				<div class="panel-body">
					<div class="form-horizontal">
						...
						<div class="form-group form-group-sm">
							...
							<div class="col-md-8">
								<input class="form-control" type="text" name="" id="Rol" required="required" value="Administrador" disabled="disabled">
								<input class="hidden" type="text" name="Rol" value="A">
							</div>							
						</div>
					</div>
