...
@section('title',' P. Médico-Crear')

@section('title-panel',' P. Médicos')

@section('contenido')
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
			<h3 class="page-header">Nuevo <small>P. Médico</small></h3>
			@if(count($errors)>0)
	...
	<div class="row">
		{!!Form::open(['url'=>'admin/usuarios/medico','method'=>'POST','autocomplete'=>'off'])!!}
		{!!Form::token()!!}
		<!-- Datos de Usuario -->
				...
				<div class=" panel-container panel-body">
					<div class="form-horizontal">
						...
						<div class="form-group form-group-sm">
							...
							<div class="col-md-8">
								<input class="form-control" type="text" name="" id="Rol" required="required" value="P. Médico" disabled="disabled">
								<input class="hidden" type="text" name="Rol" value="M">
							</div>							
						</div>
					</div>
				...
				<div class="panel-container panel-body">
					<div class="form-horizontal">
						...
						<div class="form-group form-group-sm">
							...
							<div class="col-md-8">
								<input class="form-control" type="text" name="CodMinsa" id="CodMinsa" required="required" placeholder="Ingrese Cod. Minsa">
							</div>
						</div>
						<div class="form-group form-group-sm">
							<label for="Especialidad" class="col-md-4 control-label">Especialidad:</label>
							<div class="col-md-8">
								<input class="form-control" type="textarea" name="Especialidad" id="Especialidad" required="required" placeholder="Ingrese Especialidad">
							</div>							
						</div>
						<div class="form-group form-group-sm">
							<label for="SubEspecialidad" class="col-md-4 control-label">SubEspecialidad:</label>
							<div class="col-md-8">
								<input class="form-control" type="text" name="SubEspecialidad" id="SubEspecialidad" required="required" placeholder="Ingrese SubEspecialidad">
							</div>							
						</div>
					</div>
...
@section('script')
	<script type="text/javascript">
		...
		// Se cambio de aqui a cuando se clic en submit
		// porque hasta ese momento contara cuantos elementos hay en la tabla
		//var cont=0;
		...
		//Servia para Eliminar por id la fila -> Se cambio por otra funcion arriba en $(function(){});
